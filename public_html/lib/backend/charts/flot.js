...
(function (factory) {
  if (typeof define === 'function' && define.amd) {
    define([
      'jquery.flot', 'jquery.flot.pie', 'jquery.flot.fillbetween', 'jquery.flot.stack', 'jquery.flot.resize', 'jquery.flot.categories', 'jquery.flot.time', 'jquery.flot.tooltip', 'jquery.flot.spline'
    ], factory);
  } else {
    factory();
  }
  ...
  $(function () {
    if ($('#chart-bar').length !== 0) {
      ...
      var chart = new flotDemo('#chart-bar', 'api/flot.php?type=bar'), panel = $('#chart-bar').parents('.panel'), option = {
          series: {
            bars: {
              align: 'center',
              lineWidth: 0,
  ...
  $(function () {
    if ($('#chart-bar-stacked').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-bar-stacked', 'api/flot.php?type=barstacked'), option = {
          series: {
            stack: true,
            bars: {
              align: 'center',
  ...
  $(function () {
    if ($('#chart-area').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-area', 'api/flot.php?type=area'), option = {
          series: {
            lines: {
              show: true,
              fill: 0.8
  ...
  $(function () {
    if ($('#chart-area-spline').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-area-spline', 'api/flot.php?type=areaspline'), option = {
          series: {
            lines: { show: false },
            splines: {
              show: true,
  ...
  $(function () {
    if ($('#chart-line').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-line', 'api/flot.php?type=line'), option = {
          series: {
            lines: {
              show: true,
              fill: 0.01
  ...
  $(function () {
    if ($('#chart-line-spline').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-line-spline', 'api/flot.php?type=linespline'), option = {
          series: {
            lines: { show: false },
            splines: {
              show: true,
  ...
  $(function () {
    if ($('#chart-pie1').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-pie1', 'api/flot.php?type=pie'), option = {
          series: {
            pie: {
              show: true,
              innerRadius: 0
  ...
  $(function () {
    if ($('#chart-pie2').length !== 0) {
      // Chart option/setting
      var chart = new flotDemo('#chart-pie2', 'api/flot.php?type=pie'), option = {
          series: {
            pie: {
              show: true,
              innerRadius: 0.5
