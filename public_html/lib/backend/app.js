    ...
    headerDropdown: {
      init: function (options) {
        ...
        function coreDropdown(e) {
          // define variable
          var $target = $(e.target), $mediaList = $target.find('.media-list'), $indicator = $target.find('.indicator');
          // show indicator
          ...
          $.ajax({
            ...
            var template = $target.find('.mustache-template').html(), rendered = Mustache.render(template, data);
            // hide indicator
