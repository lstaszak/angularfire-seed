...
(function (factory) {
  ...
  $(function () {
    // World map
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/data/jquery.vmap.sampledata.js'), $.getScript('../plugins/jqvmap/js/maps/jquery.vmap.world.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
    ...
    // Continents - asia
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.asia.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
    ...
    // Continents - europe
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.europe.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
    ...
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.australia.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
    ...
    // Continents - Africa
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.africa.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
    ...
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.north-america.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
    ...
    // ================================
    $.when($.getScript('../plugins/jqvmap/js/maps/continents/jquery.vmap.south-america.js'), $.Deferred(function (deferred) {
        $(deferred.resolve);
      })).done(function () {
        // hide loading indicator
