  ...
  $(function () {
    ...
    $form.on('click', 'button[type=submit]', function (e) {
      ...
      if ($form.parsley().validate()) {
        ...
        // toggle animation
        $form.removeClass('animation animating shake').addClass('animation animating shake').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
