  ...
  $(function () {
    ...
    (function () {
      ...
      var fnFormatDetails = function (oTable, nTr) {
        var sOut = '', aData = oTable.fnGetData(nTr);
      ...
      var nCloneTh = document.createElement('th'), nCloneTd = document.createElement('td');
    ...
    // ================================
    (function () {
      var $table = $('table#column-filtering'), oTable = $table.dataTable({
          'oLanguage': {
